    ...
    <>
      ...
      {context === 'search' && !activeClocks ? (
        <div className="search-scope-container" style={{ margin: '0.5em 0' }}>
          <TabButtons
            buttons={['Tareas', 'Encabezados', 'Texto']}
            values={['tasks', 'headers', 'text']}
            titles={[
              'Solo encabezados con palabra clave TODO/DONE…',
              'Título de cualquier encabezado',
              'Título y contenido (texto, listas, tablas…) de cualquier encabezado',
            ]}
            selectedButton={searchScope}
